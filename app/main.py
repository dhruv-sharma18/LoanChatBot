...
from app.api.routers import health, loans, eligibility, emi, chat
...
app.include_router(eligibility.router, prefix=f"{settings.API_V1_STR}/eligibility", tags=["Eligibility"])
app.include_router(emi.router, prefix=f"{settings.API_V1_STR}/emi-calculator", tags=["EMI Calculator"])
